...
## Core Specifications
- [**Data Model**](data_model.md) - Entity specs, relationships, lifecycle, IDs
- [**Workflows**](workflows.md) - Core user journeys (session, search, export/import)
- [**Quality**](quality.md) - Test tiers, coverage goals, conventions

## Development
- [**Development Guide**](DEVELOPMENT.md) - Developer setup, testing, contribution
